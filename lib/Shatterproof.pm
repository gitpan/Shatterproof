...
sub analyze_suspect_regions {
	...
	foreach my $score_data (@suspect_region_data){
		...
		$print_string .= "mutation_density_score:\t\t".$score_array[1]*$chromosome_localization_weight."\t(".$score_array[1].")"."\n";
		...
		$print_string .= "number_of_interchromosomal_translocation_chromosomes:\t$num_trans_chr\n";

		if($num_trans_chr>0){
			$print_string .= "interchromosomal_translocation_chromosomes:\n";
